...
public class JFrameRSA extends javax.swing.JFrame {
    ...
    /** Creates new form JFrameContainer */
    public JFrameRSA() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameRSA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
